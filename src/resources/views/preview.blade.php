...
<head>
    ...
    <style>
        ...
        .topnav { display: flex; align-items: center; justify-content: space-between; padding: .75rem 1.25rem; background: #161B22; color: #E6EDF3; border-bottom: 1px solid #30363D; }
